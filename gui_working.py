...
class DispParticleFilter(Tk):
    ...
    def __init__(self, motions, N=1000, frameLength = 0.1, displayRealRobot = True, displayGhost = False,flag=1 ):
        Tk.__init__(self)
...
if __name__ == "__main__":
    ...
    #Display window
    wind = DispParticleFilter ( motions, 500, displayRealRobot = True, displayGhost = True,flag=1 )
